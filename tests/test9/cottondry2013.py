"""
########################################################################
The cottondry2013.py module from test1 has been modified to provide
tests of the autoirrigation routines.
...
02/16/2024 Scripts modified for testing autoirrigation routines
########################################################################
"""
...
def run():
    ...
    #Setup the autoirrigation conditions
    airr = fao.AutoIrrigate()
    airr.addset('2013-113','2013-250',mad=0.4,iper=100.,ieff=80.,imax=60.)

    #Run the model
    #mdl = fao.Model('2013-113','2013-312', par, wth, irr=irr,
    #                comment = '2013 Cotton Dry')
    mdl = fao.Model('2013-113','2013-312', par, wth, autoirr=airr,
                    comment = '2013 Cotton Dry')
