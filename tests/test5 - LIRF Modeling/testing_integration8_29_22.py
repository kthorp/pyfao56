"""
8_29_2022 Note:
At the request of Kelly, I am making some substantial changes to the SoilWater class.
Testing those changes seemed to warrant a new file / configuration.
"""
...
output_folder_path = "C:/Users/joshua.brekel/python_projects/" \
...
# # Testing the string, savefile, and loadfile functions of the reworked soil water class
# # Setting Inputs
...
second_swc.savefile(filepath=f'{output_folder_path}TestCOMP_SWC_{date}.sh2o')